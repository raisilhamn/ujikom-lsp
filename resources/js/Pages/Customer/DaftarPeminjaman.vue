        ...
        <div class="relative overflow-x-auto">
            ...
            >
                ...
                <tbody>
                    ...
                    >
                        <Link
                            class="ml-3 w-10 items-center justify-center rounded-xl p-3 text-center align-middle text-sm"
                            :href="
                                route('customer.detail.peminjaman', {
                                    kode_pinjam: item.kode_pinjam,
                                })
                            "
                            ><td class="ml-3 px-6 py-4 bg-blue-100 rounded-xl">
                                {{ item.kode_pinjam }}
                            </td>
                        </Link>

                        <td class="px-6 py-4">
                            {{ $page.props.auth.peminjam.nama_peminjam }}
                        </td>
                        <!-- <td class="px-6 py-4">
                            {{ item.peminjam }}
                        </td> -->
                        ...
                        <td class="px-6 py-4">{{ item.status_peminjaman }}</td>
